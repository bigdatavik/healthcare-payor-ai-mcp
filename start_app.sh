...
# Enhanced Healthcare Payor AI System - Clean Deployment Startup Script
# This script starts the Streamlit app with all correct parameters from root directory

echo "🚀 Starting Enhanced Healthcare Payor AI System (Clean Deployment)..."
echo "=================================================================="

# Set the working directory to current location (root)
cd /Users/vik.malhotra/hospital_ai_system
